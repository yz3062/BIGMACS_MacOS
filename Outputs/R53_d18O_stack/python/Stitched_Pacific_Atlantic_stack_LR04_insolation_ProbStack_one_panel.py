...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr  3 13:56:40 2023
...
stack_1_path = '../../R49_d18O_stack/stack.txt'
...
stack_1_path = '../../R51_d18O_stack/stack.txt'
stack_1 = pd.read_table(stack_1_path, delimiter=' ')

stack_2_path = '../../R52_d18O_stack/stack.txt'
stack_2 = pd.read_table(stack_2_path, delimiter=' ')
...
axes = [plt.subplot(gs[0]),
        plt.subplot(gs[1])]
# BIAGMACS
l1 = axes[1].plot(Pacific_stack.index, Pacific_stack['mean(permil)'], label='BIGMACS Pacific uncert=1', alpha=0.8, color='C4')
...
plt.savefig('Stitched_Pacific_Atlantic_stack_LR04_insolation.png', dpi=700)
