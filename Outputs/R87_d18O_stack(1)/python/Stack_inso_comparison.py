...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug  2 10:08:08 2023
...
Pacific_stack_path = '../../R87_d18O_stack/stack.txt'
# stack = scipy.io.loadmat(stack_path)
Pacific_stack = pd.read_table(Pacific_stack_path, delimiter=' ')

Atlantic_stack_path = '../../R87_d18O_stack(1)/stack.txt'
# stack = scipy.io.loadmat(stack_path)
...
plt.savefig('Stack_old_new_comparison_Atlantic.png', dpi=700)
