...
# BIGMACS tuned
axes[1].plot(tuned_stack['X1'], tuned_stack['X2'], label='BIGMACS tuned', alpha=0.8, color='dodgerblue')
...
axes[3].legend(handles=[l1[0], l2[0], l3[0]], ncol=3, loc=[0.2,0.11])
...
plt.savefig('Untuned_tuned_comparison.png', dpi=700)
