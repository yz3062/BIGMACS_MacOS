...
axes = [plt.subplot(gs[0]),
        ...
        plt.subplot(gs[3])]
# BIAGMACS
axes[1].plot(stack.index, stack['mean(permil)'], label='BIGMACS Neptune', alpha=0.8, color='C4')
...
# BIGMACS
l1 = axes[3].plot(stack.index, stack['mean(permil)'], label='BIGMACS Neptune', alpha=0.8, color='C4')
