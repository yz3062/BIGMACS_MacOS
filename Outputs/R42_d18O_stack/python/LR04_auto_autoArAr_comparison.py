...
# read AstroChron tuned stack
auto_tuned_stack_path = '../R/tuned_stack_unextrapolated_win400.xlsx'
tuned_stack = pd.read_excel(auto_tuned_stack_path)
# geomag anchoring of floating age scale
# see details in R42_d18O_stack/python/Full_tuned_RMSE_minimization.py
tuned_stack['X1'] = tuned_stack['X1']+1.7

# read AstroChron tuned stack
auto_tuned_ArAr_stack_path = '../R/tuned_stack_unextrapolated_win500.xlsx'
tuned_ArAr_stack = pd.read_excel(auto_tuned_ArAr_stack_path)
# geomag anchoring of floating age scale
# see details in R42_d18O_stack/python/Full_tuned_RMSE_minimization.py
tuned_ArAr_stack['X1'] = tuned_ArAr_stack['X1']+1.4
...
# BIGMACS auto tuned
axes[1].plot(tuned_stack['X1'], tuned_stack['X2'], label=r'$\mathrm{BIGSTACK}_\mathrm{auto}$', alpha=0.8, color='C0')

# BIGMACS auto tuned ArAr
axes[1].plot(tuned_ArAr_stack['X1'], tuned_ArAr_stack['X2'], label=r'$\mathrm{BIGSTACK}_\mathrm{magrev}$ ArAr', alpha=0.8, color='dodgerblue')
...
# BIGMACS auto tuned
l2 = axes[3].plot(tuned_stack['X1'], tuned_stack['X2'], label=r'$\mathrm{BIGSTACK}_\mathrm{auto}$', alpha=0.8, color='C0')

# BIGMACS auto tuned ArAr
l3 = axes[3].plot(tuned_ArAr_stack['X1'], tuned_ArAr_stack['X2'], label=r'$\mathrm{BIGSTACK}_\mathrm{magrev}$ ArAr', alpha=0.8, color='dodgerblue')
...
# plt.savefig('LR04_auto_autoArAr_comparison.png', dpi=700)
