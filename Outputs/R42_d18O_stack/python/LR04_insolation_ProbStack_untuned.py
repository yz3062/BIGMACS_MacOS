...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar  5 11:35:13 2024
...
axes[3].invert_yaxis()
# BIGMACS untuned
l4 = axes[3].plot(stack_untuned_age, stack['mean(permil)'], label='BIGMACS untuned', alpha=0.8, color='C0')
...
axes[3].legend(handles=[l2[0], l3[0], l4[0]], ncol=4, loc=[0.2,0.11])
...
plt.savefig('LR04_insolation_ProbStack_untuned.png', dpi=700)
