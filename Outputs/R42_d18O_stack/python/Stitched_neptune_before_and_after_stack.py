...
# BIAGMACS no Neptune
axes[1].plot(stack.index, stack['mean(permil)'], label='BIGMACS', alpha=0.8, color='C1')
...
# BIGMACS no Neptune
l2 = axes[3].plot(stack.index, stack['mean(permil)'], label='BIGMACS', alpha=0.8, color='C1')
