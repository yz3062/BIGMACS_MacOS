...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 11 02:16:01 2025
...
# read untuned ages
untuned_df = pd.read_csv('../R/Stack_untuned_uniform_age_exclusion_expanded_1172_removed_Hobart2023.csv')

# read untuned ages
untuned_ArAr_df = pd.read_csv('../R/Stack_untuned_uniform_age_exclusion_expanded_1172_removed_ArAr_Reunion.csv')
...
# BIGMACS untuned
axes[1].plot(untuned_df['Age'], untuned_df['d18O'], label=r'$\mathrm{BIGSTACK}_\mathrm{magrev}$', color='C0')

# BIGMACS untuned ArAr
axes[1].plot(untuned_ArAr_df['Age'], untuned_ArAr_df['d18O'], label=r'$\mathrm{BIGSTACK}_\mathrm{magrev}$ ArAr', color='dodgerblue')
...
# BIGMACS untuned
l2 = axes[3].plot(untuned_df['Age'], untuned_df['d18O'], label=r'$\mathrm{BIGSTACK}_\mathrm{magrev}$', color='C0')

# BIGMACS untuned ArAr
l3 = axes[3].plot(untuned_ArAr_df['Age'], untuned_ArAr_df['d18O'], label=r'$\mathrm{BIGSTACK}_\mathrm{magrev}$ ArAr', color='dodgerblue')
...
plt.savefig('LR04_untuned_untunedArAr_comparison.png', dpi=700)
