...
stack = pd.concat([stack_1, stack_2, stack_3, stack_4, stack_5, stack_6])
...
axes = [plt.subplot(gs[0]),
        ...
        plt.subplot(gs[3])]
# BIAGMACS
axes[1].plot(stack.index, stack['mean(permil)'], label='BIGMACS Atlantic', alpha=0.8, color='C5')
...
# BIGMACS
l1 = axes[3].plot(stack.index, stack['mean(permil)'], label='BIGMACS Atlantic', alpha=0.8, color='C5')
...
plt.savefig('Stitched_Atlantic_stack_LR04_insolation_ProbStack.pdf')
