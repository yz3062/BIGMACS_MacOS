...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep 16 11:53:21 2022
...
#%% sedimentation rate
ODP1146b_aligned['Sedimentation rate'] = ODP1146b_aligned['depth(m)'].diff()*100/ODP1146b_aligned['median(kyr)'].diff()
...
axes.set_xlim((ODP1146b_aligned['median(kyr)'].min(),ODP1146b_aligned['median(kyr)'].max()))
axes.invert_yaxis()

ax_twin = axes.twinx()
ln2 = ax_twin.plot(ODP1146b_aligned['median(kyr)'],ODP1146b_aligned['Sedimentation rate'])
...
axes.set_title('ODP 1146b')


fig.set_size_inches(6,4)

plt.savefig('ODP1146b_sedimentation_rate.png', dpi=500)