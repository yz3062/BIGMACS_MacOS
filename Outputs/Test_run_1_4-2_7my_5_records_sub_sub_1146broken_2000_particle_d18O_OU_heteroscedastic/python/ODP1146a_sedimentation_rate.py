...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep 16 12:14:53 2022
...
#%% sedimentation rate
ODP1146a_aligned['Sedimentation rate'] = ODP1146a_aligned['depth(m)'].diff()*100/ODP1146a_aligned['median(kyr)'].diff()
...
axes.set_xlim((ODP1146a_aligned['median(kyr)'].min(),ODP1146a_aligned['median(kyr)'].max()))
axes.invert_yaxis()

ax_twin = axes.twinx()
ln2 = ax_twin.plot(ODP1146a_aligned['median(kyr)'],ODP1146a_aligned['Sedimentation rate'])
...
plt.savefig('ODP1146a_sedimentation_rate.png', dpi=500)