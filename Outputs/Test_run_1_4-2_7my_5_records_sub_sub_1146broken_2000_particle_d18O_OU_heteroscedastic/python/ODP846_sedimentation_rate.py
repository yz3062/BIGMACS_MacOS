...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep 16 01:22:52 2022
...
#%% sedimentation rate
ODP846_aligned['Sedimentation rate'] = ODP846_aligned['depth(m)'].diff()*100/ODP846_aligned['median(kyr)'].diff()
...
axes.set_xlim((ODP846_aligned['median(kyr)'].min(),ODP846_aligned['median(kyr)'].max()))
axes.invert_yaxis()

ax_twin = axes.twinx()
ln2 = ax_twin.plot(ODP846_aligned['median(kyr)'],ODP846_aligned['Sedimentation rate'])
...
plt.savefig('ODP846_sedimentation_rate.png', dpi=500)