...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 29 15:30:00 2022
...
axes[3].plot(stack.index, stack['mean(permil)'], label='BIGMACS', alpha=0.8)
...
axes[3].plot(LR04.index/1000, LR04, label='LRO4', color='k', zorder=1, alpha=0.5)
...
# plt.savefig('Stitched_stack_LR04_insolation.pdf')
