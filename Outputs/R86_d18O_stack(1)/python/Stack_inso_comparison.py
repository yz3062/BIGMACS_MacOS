...
Atlantic_stack_path = '../../R86_d18O_stack(1)/stack.txt'
# stack = scipy.io.loadmat(stack_path)
...
plt.savefig('Stack_old_new_comparison_Pacific.png', dpi=700)
