...
stack_2_path = '../../R80_d18O_stack/stack.txt'
# stack = scipy.io.loadmat(stack_path)
...
axes.plot(stack['age(kyr)'], stack['mean(permil)'], label='Fewer tie points (new)')
...
plt.savefig('R83_R80_stack_comparison.png', dpi=500)