...
pacific_stack_path = '../../R59_d18O_stack/stack.txt'
...
axes.plot(atlantic_stack['age(kyr)'], atlantic_stack['mean(permil)'],label='New')
axes.plot(pacific_stack['age(kyr)'], pacific_stack['mean(permil)'],label='Old')
