...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 29 14:38:12 2023
...
# read pacific data
stack_path = '../../R47_d18O_stack/results.mat'
...
Pacific_path = '../../R47_d18O_stack/stack.txt'
...
for i in range(len(df_Pacific['name'])):
    ...
    # if (ma.diff(age) > 70).any():
    #     print(df_Pacific.iloc[i]['name'][0])
...
# plt.savefig('Raw_d18O_Pacific_Atlantic_comparison.png', dpi=700)