...
axes[0].plot(Pacific_sed_rate_normalized_interpolated_Series_mean.index,
              Pacific_sed_rate_normalized_interpolated_Series_mean,
              'o-', alpha=1, color='C4',markersize=2)
axes[1].plot(Atlantic_sed_rate_normalized_interpolated_Series_mean.index,
              Atlantic_sed_rate_normalized_interpolated_Series_mean,
              'o-', alpha=1, color='C5',markersize=2)


# vertical lines for additional ages
axes[0].axvline()

axes[1].set_xlim(1500, 2100)
# axes[0].set_title('Pacific ages: 1.793 and 1.956 Ma; Atlantic ages: 1.793, 1.841, 1.863, 1.956 Ma')
...
axes[0].text(0.01, 0.9, 'A', transform=axes[0].transAxes, fontweight='bold', color='k')
axes[1].text(0.01, 0.9, 'B', transform=axes[1].transAxes, fontweight='bold', color='k')
