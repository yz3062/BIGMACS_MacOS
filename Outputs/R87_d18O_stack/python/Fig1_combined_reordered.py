...
inso_summer_65N.plot(label='65° N insolation', ax=axes[5], color='C5')
...
#%% beautification
axes[5].set_xlabel('')
axes[5].set_ylabel(r'        Insolation $W/{m^2}$')
axes[5].yaxis.set_label_position("right")
axes[5].yaxis.label.set_color('C5')
axes[5].spines['right'].set_color('C5')
axes[5].tick_params(axis='y', colors='C5')
axes[5].legend(loc='upper right', bbox_to_anchor=(1, 1.2))
...
plt.savefig('Fig1_combined_reordered.pdf')
