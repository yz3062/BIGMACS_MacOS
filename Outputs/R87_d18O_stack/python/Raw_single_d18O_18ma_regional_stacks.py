...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 13 12:40:32 2023
...
for i in range(len(df_Pacific['name'])):
    ...
    if d18O[(age>1800) & (age<1900)].size != 0: 
        ...
        plt.plot(Pacific_stack.index, Pacific_stack['mean(permil)'], color='k', alpha=0.5)
        ...
        plt.gca().axvspan(1800, 1900, color='lightgray')
...
for i in range(len(df_Atlantic['name'])):
    ...
    if d18O[(age>1800) & (age<1900)].size != 0: 
        ...
        # plt.plot(LR04.index/1000, LR04, color='k', alpha=0.5)
        plt.plot(Atlantic_stack.index, Atlantic_stack['mean(permil)'], color='k', alpha=0.5)
