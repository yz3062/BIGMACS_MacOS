...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov  7 17:22:04 2023
...
#%% plot LR04
axes[0].plot(LR04.index/1000, LR04, color='k')

#%% plot ProbStack
axes[1].plot(ProbStack.index/1000, ProbStack, color='C3', alpha=0.3)
axes[1].fill_between(ProbStack.index/1000,
                     ProbStack_upper,
                     ProbStack_lower,
                     alpha=0.3,
                     color='C3')
...
axes[2].text(0.01, 0.7, 'C', transform=axes[2].transAxes, fontweight='bold', color='k')
...
plt.savefig('Stack_LR04_ProbStack.png', dpi=700)
