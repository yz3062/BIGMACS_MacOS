...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep  7 23:06:45 2022
...
ODP1146_aligned_file_path = '../ages/ODP1146b.txt'
...
l3 = axes.plot(ODP1146_aligned['median(kyr)'], ODP1146_aligned_d18O, label='New alignment')
...
axes.set_title('ODP1146b')

fig.set_size_inches(6,4)

plt.savefig('ODP1146b_LR04_new_stack_age_diff_on_age.png', dpi=500)