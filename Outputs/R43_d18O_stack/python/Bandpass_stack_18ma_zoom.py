...
# -*- coding: utf-8 -*-
"""
Created on Mon May  1 16:45:07 2023
...
highcut = 1/18
f_order = 3
Pacific_stack_18_45_pass = butter_bandpass_filter(Pacific_stack['mean(permil)'], lowcut, highcut, fs, f_order)
Atlantic_stack_18_45_pass = butter_bandpass_filter(Atlantic_stack['mean(permil)'], lowcut, highcut, fs, f_order)
...
axes[0].plot(Pacific_stack.index, Pacific_stack_18_45_pass, color='C4', alpha=0.5)
# axes[1].plot(Atlantic_stack.index, Atlantic_stack['mean(permil)'], color='C5')
axes[1].plot(Atlantic_stack.index, Atlantic_stack_18_45_pass, color='C5', alpha=0.5)
...
plt.savefig('Bandpass_stack_18ma_zoom.png', dpi=700)