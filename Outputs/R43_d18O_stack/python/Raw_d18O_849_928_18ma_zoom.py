...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 19 12:18:59 2023
...
for i in range(len(df_Pacific['name'])):
    ...
    if '849' in df_Pacific.iloc[i]['name'][0]:
        axes[0].plot(age, d18O, linestyle='-', alpha=1, color='C4')
...
for i in range(len(df_Atlantic['name'])):
    ...
    age = age[~d18O.mask]
    d18O = d18O[~d18O.mask]
    if 'ODP928' in df_Atlantic.iloc[i]['name'][0]:
        axes[1].plot(age, d18O, linestyle='-', alpha=1, color='C5')
