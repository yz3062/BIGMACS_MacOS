...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 13 16:33:11 2023
...
for df in [df_Pacific, df_Atlantic, df_Indian]:
    for i in range(len(df['name'])):
        ...
        age = age[~d18O.mask]
        d18O = d18O[~d18O.mask]
        # d18O_Series = d18O_Series.iloc[1800:1900]
        if d18O[(age>1800) & (age<1900)].size != 0: 
            fig = plt.figure()
            d18O_Series = pd.Series(data=age_model_interp(age,
                                                          d18O,
                                                          list(range(1800,1901))),
                                    index=list(range(1800,1901)))
            autocorrelation_plot(d18O_Series)
            plt.title(df.iloc[i]['name'][0])
            plt.savefig(df.iloc[i]['name'][0] + '_autocorr', dpi=500)
...
#     age = age[~d18O.mask]
#     d18O = d18O[~d18O.mask]
#     d18O_Series = pd.Series(data=d18O, index=age)
#     d18O_Series = d18O_Series[1800:1900]
#     fig = plt.figure()
#     if d18O[(age>1800) & (age<1900)].size != 0: 
#         autocorrelation_plot(d18O)
...
#     fig = plt.figure()
#     if d18O[(age>1800) & (age<1900)].size != 0: 
#         plt.plot(age, autocorr(d18O), color='C5')
...
#     fig = plt.figure()
#     if d18O[(age>1800) & (age<1900)].size != 0: 
#         plt.plot(age, autocorr(d18O), color='C6')
